  ...
  return (
    ...
    >
      ...
      <div className="pp-section" id="pp-color-section">
        ...
        <div className="pp-row">
          <div
            className="color-dot"
            id="strokeDot"
            style={{ background: "#e2e2ef" }}
            title={t("strokeColor")}
          >
            <label htmlFor="strokeColorInput" className="sr-only">
              {t("strokeColor")}
            </label>
            <input
              type="color"
          ...
          <div
            ...
            title={t("fillColor")}
          >
            <label htmlFor="fillColorInput" className="sr-only">
              {t("fillColor")}
            </label>
            <input
              type="color"
      ...
      <div className="pp-section" id="pp-stroke-width-section">
        ...
        <div className="pp-row">
          <button
            className="sz-btn on"
            id="sz1"
            onClick={() => call("setStrokeWidth", 1.5)}
            aria-label={t("strokeThin")}
            aria-pressed="true"
          >
            <div
              className="sz-line"
          ...
          <button
            className="sz-btn"
            id="sz3"
            onClick={() => call("setStrokeWidth", 3)}
            aria-label={t("strokeMedium")}
            aria-pressed="false"
          >
            <div
              className="sz-line"
          ...
          <button
            className="sz-btn"
            id="sz5"
            onClick={() => call("setStrokeWidth", 5)}
            aria-label={t("strokeThick")}
            aria-pressed="false"
          >
            <div
              className="sz-line"
      ...
      <div className="pp-section" id="pp-stroke-dash-section">
        ...
        <div className="pp-row">
          <button
            className="sz-btn on"
            id="dash-solid"
            onClick={() => call("setStrokeDash", "solid")}
            aria-label={t("dashSolid")}
            aria-pressed="true"
          >
            <div
              className="sz-line"
          ...
          <button
            className="sz-btn"
            id="dash-dashed"
            onClick={() => call("setStrokeDash", "dashed")}
            aria-label={t("dashDashed")}
            aria-pressed="false"
          >
          ...
          <button
            className="sz-btn"
            id="dash-dotted"
            onClick={() => call("setStrokeDash", "dotted")}
            aria-label={t("dashDotted")}
            aria-pressed="false"
          >
      ...
      <div className="pp-section hide" id="pp-fill-pattern-section">
        ...
        <div className="pp-row">
          <button
            className="sz-btn on"
            id="fp-filled"
            onClick={() => call("setFillPattern", "filled")}
            aria-label={t("fpFilled")}
            aria-pressed="true"
          >
          ...
          <button
            className="sz-btn"
            id="fp-striped"
            onClick={() => call("setFillPattern", "striped")}
            aria-label={t("fpStriped")}
            aria-pressed="false"
          >
            <svg
              viewBox="0 0 18 18"
              ...
              height="16"
              aria-hidden="true"
              style={{ stroke: "currentColor", fill: "none", strokeWidth: 1.2 }}
            >
          ...
          <button
            className="sz-btn"
            id="fp-crossed"
            onClick={() => call("setFillPattern", "crossed")}
            aria-label={t("fpCrossed")}
            aria-pressed="false"
          >
            <svg
              viewBox="0 0 18 18"
      ...
      <div className="pp-section hide" id="pp-border-radius-section">
        ...
        <div className="pp-row">
          <button
            className="sz-btn on"
            id="br-sharp"
            onClick={() => call("setBorderRadius", "sharp")}
            aria-label={t("brSharp")}
            aria-pressed="true"
          >
            <svg
              viewBox="0 0 18 18"
          ...
          <button
            className="sz-btn"
            id="br-rounded"
            onClick={() => call("setBorderRadius", "rounded")}
            aria-label={t("brRounded")}
            aria-pressed="false"
          >
            <svg
              viewBox="0 0 18 18"
      ...
      <div className="pp-section hide" id="pp-sloppiness-section">
        ...
        <div className="pp-row">
          <button
            className="sz-btn on"
            id="sloppy-architect"
            onClick={() => call("setSloppiness", "architect")}
            aria-label={t("sloppyArchitect")}
            aria-pressed="true"
          >
            <svg
              viewBox="0 0 18 18"
          ...
          <button
            className="sz-btn"
            id="sloppy-artist"
            onClick={() => call("setSloppiness", "artist")}
            aria-label={t("sloppyArtist")}
            aria-pressed="false"
          >
            <svg
              viewBox="0 0 18 18"
            ...
            >
              <path d="M4 14 Q7 5 14 4" />
            </svg>
          </button>
          <button
            className="sz-btn"
            id="sloppy-cartoonist"
            onClick={() => call("setSloppiness", "cartoonist")}
            aria-label={t("sloppyCartoonist")}
            aria-pressed="false"
          >
            <svg
              viewBox="0 0 18 18"
            ...
            >
              <path d="M4 14 Q9 3 14 4" />
            </svg>
          </button>
          <button
            className="sz-btn"
            id="sloppy-doodle"
            onClick={() => call("setSloppiness", "doodle")}
            aria-label={t("sloppyDoodle")}
            aria-pressed="false"
          >
            <svg
              viewBox="0 0 18 18"
            ...
            >
              <path d="M4 14 Q7 4 14 4" />
              <path d="M4 14 Q8 5 14 5" />
            </svg>
          </button>
        </div>
      </div>
      ...
      <div className="pp-section hide" id="pp-arrow-type-section">
        ...
        <div className="pp-row">
          <button
            className="sz-btn on"
            id="at-sharp"
            onClick={() => call("setArrowType", "sharp")}
            aria-label={t("arrowSharp")}
            aria-pressed="true"
          >
            <svg
              viewBox="0 0 18 18"
          ...
          <button
            className="sz-btn"
            id="at-curved"
            onClick={() => call("setArrowType", "curved")}
            aria-label={t("arrowCurved")}
            aria-pressed="false"
          >
            <svg
              viewBox="0 0 18 18"
          ...
          <button
            className="sz-btn"
            id="at-elbow"
            onClick={() => call("setArrowType", "elbow")}
            aria-label={t("arrowElbow")}
            aria-pressed="false"
          >
            <svg
              viewBox="0 0 18 18"
      ...
      <div className="pp-section hide" id="pp-arrow-heads-section">
        ...
        <div className="pp-row" style={{ gap: "3px" }}>
          <button
            className="sz-btn"
            id="ahe-none"
            onClick={() => call("setArrowHeadEnd", "none")}
            aria-label={t("headNone")}
            aria-pressed="false"
          >
            <svg
              viewBox="0 0 18 9"
          ...
          <button
            className="sz-btn on"
            id="ahe-open"
            onClick={() => call("setArrowHeadEnd", "open")}
            aria-label={t("headOpen")}
            aria-pressed="true"
          >
            <svg
              viewBox="0 0 18 9"
            ...
            >
              ...
              <polyline points="10,1 14,4.5 10,8" />
            </svg>
          </button>
          <button
            className="sz-btn"
            id="ahe-triangle"
            onClick={() => call("setArrowHeadEnd", "triangle")}
            aria-label={t("headTriangle")}
            aria-pressed="false"
          >
            <svg viewBox="0 0 18 9" width="18" height="9" aria-hidden="true">
              <line
                x1="2"
                y1="4.5"
                x2="11"
                ...
                fill="none"
              />
              <polygon points="11,1 16,4.5 11,8" fill="currentColor" />
            </svg>
          </button>
          <button
            className="sz-btn"
            id="ahe-triangleoutline"
            onClick={() => call("setArrowHeadEnd", "triangle-outline")}
            aria-label={t("headTriangleOutline")}
            aria-pressed="false"
          >
            <svg
              viewBox="0 0 18 9"
              ...
              style={{ stroke: "currentColor", fill: "none", strokeWidth: 1.5 }}
            >
              <line x1="2" y1="4.5" x2="11" y2="4.5" />
              <polygon points="11,1 16,4.5 11,8" />
            </svg>
          </button>
        </div>
        {/* Start head row */}
        <div className="pp-row" style={{ gap: "3px" }}>
          <button
            className="sz-btn on"
            id="ahs-none"
            onClick={() => call("setArrowHeadStart", "none")}
            aria-label={t("headStartNone")}
            aria-pressed="true"
          >
            <svg
              viewBox="0 0 18 9"
          ...
          <button
            className="sz-btn"
            id="ahs-open"
            onClick={() => call("setArrowHeadStart", "open")}
            aria-label={t("headStartOpen")}
            aria-pressed="false"
          >
            <svg
              viewBox="0 0 18 9"
            ...
            >
              <line x1="5" y1="4.5" x2="16" y2="4.5" />
              <polyline points="8,1 4,4.5 8,8" />
            </svg>
          </button>
          <button
            className="sz-btn"
            id="ahs-triangle"
            onClick={() => call("setArrowHeadStart", "triangle")}
            aria-label={t("headStartTriangle")}
            aria-pressed="false"
          >
            <svg viewBox="0 0 18 9" width="18" height="9" aria-hidden="true">
              <line
                ...
                fill="none"
              />
              <polygon points="7,1 2,4.5 7,8" fill="currentColor" />
            </svg>
          </button>
          <button
            className="sz-btn"
            id="ahs-triangleoutline"
            onClick={() => call("setArrowHeadStart", "triangle-outline")}
            aria-label={t("headStartOutline")}
            aria-pressed="false"
          >
            <svg
              viewBox="0 0 18 9"
              ...
              style={{ stroke: "currentColor", fill: "none", strokeWidth: 1.5 }}
            >
              <line x1="7" y1="4.5" x2="16" y2="4.5" />
              <polygon points="7,1 2,4.5 7,8" />
            </svg>
          </button>
        </div>
      </div>
      ...
      <div className="pp-section" id="pp-opacity-section">
        <label className="pp-label" htmlFor="opacitySlider">
          {t("opacity")}
        </label>
        <div className="pp-row">
          <input
          ...
          />
          <span id="opacityValue" className="pp-val">
            100%
          </span>
        </div>
      </div>
      ...
      <div className="pp-section hide" id="pp-link-section">
        <label className="pp-label" htmlFor="linkInput">
          {t("addLink")}
        </label>
        <div className="pp-row">
          <input
      ...
      <div className="pp-section hide" id="pp-group-section">
        ...
        <div className="pp-row" style={{ gap: "4px" }}>
          <button
            ...
            aria-label={t("groupObjects")}
            title={t("groupObjects")}
            style={{ width: 28, height: 28 }}
          >
            <svg
              viewBox="0 0 20 20"
          ...
          <button
            ...
            aria-label={t("ungroupObjects")}
            title={t("ungroupObjects")}
            style={{ width: 28, height: 28 }}
          >
            <svg
              viewBox="0 0 20 20"
        ...
        <div className="pp-row" style={{ gap: "4px", marginTop: "4px" }}>
          <button
            className="tbtn"
            onClick={() => call("alignLeft")}
            aria-label={t("alignLeft")}
            title={t("alignLeft")}
            style={{ width: 28, height: 28 }}
          >
            <svg viewBox="0 0 20 20" width="14" height="14" aria-hidden="true">
              <rect x="2" y="2" width="10" height="4" fill="currentColor" />
              <rect x="2" y="10" width="14" height="4" fill="currentColor" />
              <line
                x1="1"
                y1="0"
                x2="1"
          ...
          <button
            className="tbtn"
            onClick={() => call("alignCenterH")}
            aria-label={t("alignCenterH")}
            title={t("alignCenterH")}
            style={{ width: 28, height: 28 }}
          >
            <svg viewBox="0 0 20 20" width="14" height="14" aria-hidden="true">
              <rect x="5" y="2" width="10" height="4" fill="currentColor" />
          ...
          <button
            className="tbtn"
            onClick={() => call("alignRight")}
            aria-label={t("alignRight")}
            title={t("alignRight")}
            style={{ width: 28, height: 28 }}
          >
            <svg viewBox="0 0 20 20" width="14" height="14" aria-hidden="true">
              <rect x="8" y="2" width="10" height="4" fill="currentColor" />
              <rect x="4" y="10" width="14" height="4" fill="currentColor" />
              <line
                x1="19"
                y1="0"
                x2="19"
          ...
          <button
            className="tbtn"
            onClick={() => call("alignCenterV")}
            aria-label={t("alignCenterV")}
            title={t("alignCenterV")}
            style={{ width: 28, height: 28 }}
          >
            <svg viewBox="0 0 20 20" width="14" height="14" aria-hidden="true">
              <rect x="2" y="5" width="4" height="10" fill="currentColor" />
              <rect x="10" y="3" width="4" height="14" fill="currentColor" />
              <line
                x1="0"
                y1="10"
                x2="20"
          ...
          <button
            className="tbtn"
            onClick={() => call("alignBottom")}
            aria-label={t("alignBottom")}
            title={t("alignBottom")}
            style={{ width: 28, height: 28 }}
          >
            <svg viewBox="0 0 20 20" width="14" height="14" aria-hidden="true">
              <rect x="2" y="8" width="4" height="10" fill="currentColor" />
              <rect x="10" y="4" width="4" height="14" fill="currentColor" />
              <line
                x1="0"
                y1="19"
                x2="20"
      ...
      <div className="pp-section hide" id="pp-mermaid-section">
        <label className="pp-label" htmlFor="mermaidCodeInput">
          {t("mermaidCode")}
        </label>
