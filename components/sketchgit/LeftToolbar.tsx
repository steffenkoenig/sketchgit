...
export const LeftToolbar = React.memo(function LeftToolbar({
  call,
}: LeftToolbarProps) {
  ...
  return (
    ...
    >
      ...
      <button
        className="tbtn"
        id="tellipse"
        onClick={() => call("setTool", "ellipse")}
        aria-label="Ellipse tool (E)"
        aria-pressed="false"
      >
        <svg viewBox="0 0 24 24" aria-hidden="true" focusable="false">
      ...
      <button
        className="tbtn"
        id="teraser"
        onClick={() => call("setTool", "eraser")}
        aria-label="Eraser tool (X)"
        aria-pressed="false"
      >
        <svg viewBox="0 0 24 24" aria-hidden="true" focusable="false">
